...
export const adminCommands: CommandDef[] = [
  ...
  },
  {
    ...
    display: { title: "Ssh Keys", cols: ["algorithm>Algorithm", "entity_ids>Entity Ids", "fingerprint>Fingerprint", "name>Name", "@created_at>Created At", "#contact_id>ID"] },
  ...
  },
  {
    ...
    options: [
      ...
      { flags: "--entity-ids <entity-ids>", description: "Comma-separated entity IDs to scope access" },
      { flags: "--name <name>", description: "Display name", required: true },
      { flags: "--public-key <public-key>", description: "SSH public key (OpenSSH format)", required: true },
    ...
    successTemplate: "Ssh Keys created",
  },
  {
    name: "ssh-keys",
    description: "List registered SSH public keys",
    ...
    successTemplate: "Ssh Keys deleted",
  },
  {
